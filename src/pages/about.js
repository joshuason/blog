    ...
    <PageContainer activePage="about">
      <div className="about">
        ...
        <div className="about-content">
          ...
          <h2>this.me</h2>
          <p>
            I'm just a regular guy who likes to tinker with things that tickle
            my curiously creative curiosities. <br />
          ...
          <p>
            ...
            sustanance from various other blogs, essays and online
            documentation. I hope you enjoy reading my struggles unfiltered and
            that you gain something of value.
          </p>
          ...
          <h3>GODSPEED</h3>
          <i>
            (I thought I should end with something catchy and vaguely
            appropriate)
          </i>
        </div>{" "}
        {/* ->| .about-content */}
