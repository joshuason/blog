...
So you probably already know how this works when undergoing a challenge: read some [related docs](https://www.gatsbyjs.org/docs/mdx/), follow along and jiggle things around until it works. Very, _very_ methodically, of course.
